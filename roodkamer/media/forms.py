...
class ArticleForm(Form):
    ...
    Attributes:
        title (:class:`~wtforms.fields.StringField`): This is the title field. It is
            required, and must contain no less than 3 characters and no more
            than 128. Title is validated for uniqueness.
        ...
        post (:class:`wtforms.fields.SubmitField`): Submit button. For submitting an
            article.
        cancel (:class:`wtforms.fields.SubmitField`): Cancel button. For not submitting 
            an article.
        is_visible (:class:`~wtforms.fields.BooleanField`): A checkbox for
            determining if the article is displayed on the site.
    subject_tags (:class:`~wtforms.fields.StringField`): A text input modified with
            bootrap-tagsinput script for any number of identifying tags to be 
